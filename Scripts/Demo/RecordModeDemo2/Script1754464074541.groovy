...
try {
    WebUI.acceptAlert(5) // <-- Coba aja klik OK di pop-up, beri waktu 5 detik
} catch (Exception e) {
    // Kalau gagal karena pop-upnya nggak ada, biarin aja (do nothing)
}
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Page_CURA Healthcare Service/td_27'), 10)

WebUI.click(findTestObject('Object Repository/Page_CURA Healthcare Service/td_27'))

WebUI.setText(findTestObject('Object Repository/Page_CURA Healthcare Service/textarea_Comment_comment'), 'For MCU')
